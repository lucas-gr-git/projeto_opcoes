...
if ticker_consulta:
    ...
    if df_periodo.empty:
        ...
        if falharam:
            st.caption(f"⚠️ Não consegui carregar: {', '.join(falharam)} — tente novamente ou verifique "
                       "se o ticker do ETF está disponível no seu plano BRAPI.")
