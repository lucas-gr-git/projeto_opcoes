...
with tabs[3]:
    ...
    if ticker_sel != "OUTRO":
        ...
        grafico_ativo(historico_diario_cache(ticker_sel, get_token()),
                      strikes={f"Put R$ {d_sel['K_put']:.2f}": d_sel["K_put"],
                               f"Call R$ {d_sel['K_call']:.2f}": d_sel["K_call"]})
...
with tabs[4]:
    ...
    if ticker_sel != "OUTRO":
        st.markdown("**📊 Gráfico do ativo com K1/K2**")
        grafico_ativo(historico_diario_cache(ticker_sel, get_token()),
                      strikes={f"K1 R$ {t['K1']:.2f}": t["K1"], f"K2 R$ {t['K2']:.2f}": t["K2"]})
...
with tabs[5]:
    ...
    if ticker_sel != "OUTRO":
        st.markdown("**📊 Gráfico do ativo com K1/K2**")
        grafico_ativo(historico_diario_cache(ticker_sel, get_token()),
                      strikes={f"K1 R$ {tb['K1']:.2f}": tb["K1"], f"K2 R$ {tb['K2']:.2f}": tb["K2"]})
...
with tabs[6]:
    ...
    if ticker_sel != "OUTRO":
        st.markdown("**📊 Gráfico do ativo com K Put/K Call**")
        grafico_ativo(historico_diario_cache(ticker_sel, get_token()),
                      strikes={f"K Put R$ {ss['K_put']:.2f}": ss["K_put"],
                               f"K Call R$ {ss['K_call']:.2f}": ss["K_call"]})
